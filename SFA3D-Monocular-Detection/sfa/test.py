...
def parse_test_configs():
    ...
    parser.add_argument('--pretrained_path', type=str,
                        default='/content/drive/MyDrive/SFA3D/checkpoints/fpn_resnet_18/Model_fpn_resnet_18_epoch_100.pth', metavar='PATH')
    ...
    configs.root_dir = '/content/drive/MyDrive/SFA3D/'
